    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={{ marginTop: 8, opacity: 0.8 }}>
          Cole o texto do grupo (com “Goleiros: / Jogadores de Linha: / Reservas:”) e
...
/* ===== Anexa o getLayout sem usar 'any' ===== */
export default Object.assign(SorteioPage, {
